...
const Navbar = () => {
  ...
  return (
    (<nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      ...
      {!user ? <button className="cursor-pointer w-24 transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 md:w-32 dark:bg-white dark:text-black dark:hover:bg-gray-200">
        <SignInButton />
      </button> :
        <div className='flex items-center gap-5'>
          <Button>Create Object</Button>
          <Button>My Objects</Button>
          <UserButton />
        </div>
      }
    </nav>)
